...
namespace BELISA_POV
{
    public partial class frmProveedores : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            {
                // IF IS A NEW SUPPLIER -- REGISTER
                int idnewSUPPLIER = new BN_Proveedor().Registrar(objProveedor, out mensaje);
                if (idnewSUPPLIER != 0)
                {
                    dgvdata.Rows.Add(new object[] {"",idnewSUPPLIER,txtdocumento.Text,txtnombrecompleto.Text,txtcorreo.Text,txttelefono.Text,
            ...
            {
                // IF IS A OLD SUPPLIER -- EDIT
                bool rest = new BN_Proveedor().Editar(objProveedor, out mensaje);
                if (rest)
                {
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    if (dgvdata.Rows[indice].Cells["Telefono"].Value != null)
                        txtcorreo.Text = dgvdata.Rows[indice].Cells["Telefono"].Value.ToString();
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Deseas Eliminar El Proveedor?", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Proveedor objProveedor = new Proveedor()
                    {
                    ...
                    bool answer = new BN_Proveedor().Eliminar(objProveedor, out mensaje);
